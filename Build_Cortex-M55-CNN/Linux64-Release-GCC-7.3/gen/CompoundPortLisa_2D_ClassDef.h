...
/** \file
 * Class definition for protocol CompoundPortLisa_2D.
 * GeneratedFrom: "/home/odishe01/FastModel/FastModelsPortfolio_11.10/LISA/CompoundPort.lisa"
 */

#ifndef CompoundPortLisa_2D_ClassDef_h_
#define CompoundPortLisa_2D_ClassDef_h_
...
public:
    ...
    void SetPort(CompoundPortLisa_2D *port) { thisPort = port; }
...
private:
    ...
    CompoundPortLisa_2D *thisPort;
};


// Protocol (port) class definition
class CompoundPortLisa_2D: public sg::Port
{
private:
...
// Mapping object
// (these ports are implemented inside CompoundPortLisa_2D__AddressablePort)
class CompoundPortLisa_2D__AddressablePort_OutPort: public CompoundPortLisa_2D
{
public:
    // constructor
    CompoundPortLisa_2D__AddressablePort_OutPort(uint32_t inFirst,
                                                 uint32_t inLast,
                                                 uint32_t outFirst,
                                                 uint32_t outLast):
    inFirst__(inFirst),
...
class CompoundPortLisa_2D__AddressablePort: public CompoundPortLisa_2D
{
public:
    ...
    CompoundPortLisa_2D__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &CompoundPortLisa_2D__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &CompoundPortLisa_2D__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &CompoundPortLisa_2D__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &CompoundPortLisa_2D__AddressablePort::isMapped__, this);
    ...
    CompoundPortLisa_2D__AddressablePort_OutPort *locateOutPort__(uint32_t &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        CompoundPortLisa_2D__AddressablePort_OutPort *masterPort =
            new CompoundPortLisa_2D__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new CompoundPortLisa_2D__AddressablePort_OutPort(0, uint32_t(0) - 1, 0, uint32_t(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((CompoundPortLisa_2D__AddressablePort_OutPort*)port);
...
private:
    typedef std::list<CompoundPortLisa_2D__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    CompoundPortLisa_2D__AddressablePort_OutPort *defaultOutPort__;
