...
/** \file
 * Class definition for Component AMBAPVSignal2SGSignal.
 */

#ifndef Component_Component__AMBAPVSignal2SGSignal_ClassDef_h_
#define Component_Component__AMBAPVSignal2SGSignal_ClassDef_h_
...
SG_DMA_DSO
#endif
Component__AMBAPVSignal2SGSignal: public SystemGenComponent
{
    // CADI class can see the resources (for MEMORY sections).
    friend class Component__AMBAPVSignal2SGSignal_CADI;
private:
    // resources
    //
...
public:
    ...
    Component__AMBAPVSignal2SGSignal(const char *instName, sg::SimulationContext* simulationContext, const sg::Params & params);
    ~Component__AMBAPVSignal2SGSignal();

    // abstract ports
	Signal_2D sg_signal_m; 
	AMBAPVSignal_2D amba_pv_signal_s; 
	...
	void step();
	void abstract_port__amba_pv_signal_s__set_state(int export_id, const bool& state);
...
namespace MT {
    ...
    //
    // This represents Component__AMBAPVSignal2SGSignal wrapped through a proxy so that it can
    ...
    SG_DMA_DSO
#endif
    Component__AMBAPVSignal2SGSignal : public sg::ComponentBaseForwarder
    {
        using wrapped_type = DMA_NMS::Component__AMBAPVSignal2SGSignal;
    public:
